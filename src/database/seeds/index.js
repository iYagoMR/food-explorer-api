...
exports.seed = async function(knex) {
    ...
    await knex('ingredients').insert([
        { name: 'Feta Cheese', dish_id: 1, user_id: 3 },
        { name: 'Olives', dish_id: 1, user_id: 3 },
        { name: 'Tomatoes', dish_id: 1, user_id: 3 },
        { name: 'Kale', dish_id: 2, user_id: 3 },
        { name: 'Grilled Chicken', dish_id: 2, user_id: 3 },
        { name: 'Lettuce', dish_id: 3, user_id: 3 },
        { name: 'Shrimp', dish_id: 4, user_id: 3 },
        { name: 'Garlic Butter', dish_id: 4, user_id: 3 },
        { name: 'Rustic Bread', dish_id: 5, user_id: 3 },
        { name: 'Ham', dish_id: 5, user_id: 3 },
        { name: 'Puff Pastry', dish_id: 6, user_id: 3 },
        { name: 'Plums', dish_id: 7, user_id: 3 },
        { name: 'Almond Flour', dish_id: 8, user_id: 3 },
        { name: 'Sugar', dish_id: 8, user_id: 3 },
        { name: 'Plum Puree', dish_id: 9, user_id: 3 }
    ]);
};
